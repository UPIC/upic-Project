 ...
 * 4.照片
 */
 var getProjectInfoByProjectNum = "";
     ...
     */
     $.ajax({
        ...
        success: function (result) {// 返回数据根据结果进行相应的处理
            ...
            if (result.status=="") {htmls+="已报名"};
            if (result.status=="") {htmls+="已完成"};
            htmls += "  </div>";
            htmls += "  </li>";
            htmls += " <li>";
            htmls += "   <div class='list-name'>";
            ...
            htmls += "  </div>";
            htmls += "  <div class='list-det'>";
            htmls += getDate(result[i].startTime, "MM-dd hh:mm") + " - " + getDate(result[i].endTime;
            htmls += "   </div>";
            htmls += "  </li>";
            htmls += "   <li>";
            htmls += "   <div class='list-name'>";
            ...
            htmls += "   </div>";
            htmls += "   <div class='list-det'>";
            htmls += getDate(result[i].signUpEndTime, "MM-dd hh:mm");
            htmls += "     </div>";
            htmls += "  </li>";
