...
function addHtmls(result,method){
	...
	htmls+="<span>活动时间："+getDate(result[i].startTime,"yy-MM-dd hh:mm")+"-"+getDate(result[i].startTime,"yy-MM-dd hh:mm")+"</span><br> <span>报名截止时间："+getDate(result[i].signUpEndTime,"yy-MM-dd hh:mm")+"</span><br>";
