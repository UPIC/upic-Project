 ...
 * @Author: Marte
 * 查看详情
 * @Date:   2017-09-19 15:10:18
 * @Last Modified by:   Marte
 * @Last Modified time: 2017-11-09 14:53:20
 */
...
function addHtmls(data) {
    ...
    htmls += "<li class='li-other'><div class='list-line'>项目详情</div><div class='li-text'><textarea name='' rows='3' cols='47'>" + data.content + "</textarea></div></li>";

    $("#content").html(htmls);

    var htmlss = "";
    htmlss += "<a href='teacher-num2.html?projectNum=" + data.projectNum + "'>";
