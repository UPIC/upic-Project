...
public class SpringBootJpaTestApplicationTests {
	...
	public void testGetProjectBySql() {
		...
		// Page<ProjectInfo> projectInfoPage =
		// projectService.getProjectBySql(statusList, projectCategoryList, pageRequest);
		// if (projectInfoPage != null) {
		// System.out.println(projectInfoPage.getTotalElements() + "");
		// System.out.println(projectInfoPage.getTotalPages());
		// for (ProjectInfo projectInfo : projectInfoPage.getContent()) {
	...
	public void testRedis() throws NoSuchAlgorithmException, UnsupportedEncodingException {
		...
		// 随机生成AccessToken
		String token = "SQR3242342421424" + nowTime + "QR";
		...
		redisService.set("QR" + "SQR3242342421424", accessToken, 15);
	}
	...
	public void testRedis1() {
		...
		System.out.println(redisService.get("QR" + "SQR3242342421424"));
