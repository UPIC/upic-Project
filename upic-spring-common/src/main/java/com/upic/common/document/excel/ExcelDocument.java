package com.upic.common.document.excel;
        ...
        try {
            ...
            for (int i = 0; i < data.size(); i++) {
                ...
                for (int j = 0; j < baseModel.length; j++) {
                    if ((baseModel[j] == "projectNum" || baseModel[j] == "studentNum") && c.getName().equals("IntegralLogInfo")) {

                    } else {
                        Method method = fieldToMap.get(baseModel[j].toLowerCase());
